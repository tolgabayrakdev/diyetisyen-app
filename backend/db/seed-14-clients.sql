-- Seed Data: 14 Örnek Danışan
-- 
-- Kullanım:
-- psql -U postgres -d your_database -f backend/db/seed-14-clients.sql
-- veya
-- psql içinde: \i backend/db/seed-14-clients.sql

-- Türk isimleri ve soyisimleri ile 14 farklı danışan oluşturur
DO $$
DECLARE
...
BEGIN
    ...
    RAISE NOTICE '14 danışan oluşturuluyor...';
    ...
    FOR i IN 1..14 LOOP
        ...
        phone_val := '555' || lpad((2000000 + i)::text, 7, '0');
    ...
    RAISE NOTICE '14 danışan başarıyla oluşturuldu!';
END $$;

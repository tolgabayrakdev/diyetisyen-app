...
const features: Feature[] = [
  ...
  },
  {
    ...
    description: "Danışanlarınızla özel diyet planları oluşturun. Gelişmiş metin editörü ile haftanın günlerini, öğünleri ve tüm detayları istediğiniz gibi formatlayın. Mevcut diyet planlarını yükleyin veya sıfırdan yazın. Profesyonel ve kişiselleştirilmiş diyet planları hazırlayın.",
    image: "/features/diyet-plani.png",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
